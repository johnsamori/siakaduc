...
// Get upload files
    ...
    protected function editRow(): bool
    {
        ...
        // Check field with unique index (nidn)
        if ($this->nidn->CurrentValue != "") {
            $filterChk = "(`nidn` = '" . AdjustSql($this->nidn->CurrentValue) . "')";
            ...
            if ($rsChk->fetchAssociative()) {
                $idxErrMsg = sprintf($this->language->phrase("DuplicateIndex"), $this->nidn->CurrentValue, $this->nidn->caption());
