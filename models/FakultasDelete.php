 ...
 * Page class
 */
class FakultasDelete extends Fakultas
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "FakultasDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "fakultasdelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("fakultaslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("fakultaslist"); // Return to list
                return;
            }
        }
