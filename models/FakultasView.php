 ...
 * Page class
 */
class FakultasView extends Fakultas
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "FakultasView";
    ...
    // CSS class/style
    public string $CurrentPageName = "fakultasview";
...
// Is modal
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "fakultaslist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("fakultaslist"); // Return to list page
                        return;
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "fakultaslist"; // No matching record, return to list
                    } else {
