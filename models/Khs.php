 ...
 * Table class for khs
 */
class Khs extends DbTable implements LookupTableInterface
{
    ...
    // Fields
    public DbField $id;
    public DbField $mahasiswa_id;
    public DbField $matakuliah_id;
    public DbField $tahun_akademik_id;
    public DbField $nilai_huruf;
    public DbField $nilai_angka;
    ...
    public function __construct(Language $language, AdvancedSecurity $security)
    {
        ...
        $this->UpdateTable = "khs"; // Update table
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // mahasiswa_id
        $this->mahasiswa_id = new DbField(
            $this, // Table
            'x_mahasiswa_id', // Variable name
            'mahasiswa_id', // Name
            '`mahasiswa_id`', // Expression
            '`mahasiswa_id`', // Basic search expression
            3, // Type
            11, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`mahasiswa_id`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->mahasiswa_id->InputTextType = "text";
        $this->mahasiswa_id->Raw = true;
        $this->mahasiswa_id->DefaultErrorMessage = $this->language->phrase("IncorrectInteger");
        $this->mahasiswa_id->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->Fields['mahasiswa_id'] = &$this->mahasiswa_id;

        // matakuliah_id
        $this->matakuliah_id = new DbField(
            $this, // Table
            'x_matakuliah_id', // Variable name
            'matakuliah_id', // Name
            '`matakuliah_id`', // Expression
            '`matakuliah_id`', // Basic search expression
            3, // Type
            11, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`matakuliah_id`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->matakuliah_id->InputTextType = "text";
        $this->matakuliah_id->Raw = true;
        $this->matakuliah_id->DefaultErrorMessage = $this->language->phrase("IncorrectInteger");
        $this->matakuliah_id->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->Fields['matakuliah_id'] = &$this->matakuliah_id;

        // tahun_akademik_id
        $this->tahun_akademik_id = new DbField(
            $this, // Table
            'x_tahun_akademik_id', // Variable name
            'tahun_akademik_id', // Name
            '`tahun_akademik_id`', // Expression
            '`tahun_akademik_id`', // Basic search expression
            3, // Type
            11, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`tahun_akademik_id`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->tahun_akademik_id->InputTextType = "text";
        $this->tahun_akademik_id->Raw = true;
        $this->tahun_akademik_id->DefaultErrorMessage = $this->language->phrase("IncorrectInteger");
        $this->tahun_akademik_id->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->Fields['tahun_akademik_id'] = &$this->tahun_akademik_id;

        // nilai_huruf
        $this->nilai_huruf = new DbField(
            $this, // Table
            'x_nilai_huruf', // Variable name
            'nilai_huruf', // Name
            '`nilai_huruf`', // Expression
            '`nilai_huruf`', // Basic search expression
            200, // Type
            1, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`nilai_huruf`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->nilai_huruf->InputTextType = "text";
        $this->nilai_huruf->Raw = true;
        global $CurrentLanguage;
        switch ($CurrentLanguage) {
            case "en-US":
                $this->nilai_huruf->Lookup = new Lookup($this->nilai_huruf, 'khs', false, '', ["","","",""], '', "", [], [], [], [], [], [], false, '', '', "");
                break;
            default:
                $this->nilai_huruf->Lookup = new Lookup($this->nilai_huruf, 'khs', false, '', ["","","",""], '', "", [], [], [], [], [], [], false, '', '', "");
                break;
        }
        $this->nilai_huruf->OptionCount = 5;
        $this->nilai_huruf->SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"];
        $this->Fields['nilai_huruf'] = &$this->nilai_huruf;

        // nilai_angka
        $this->nilai_angka = new DbField(
            $this, // Table
            'x_nilai_angka', // Variable name
            'nilai_angka', // Name
            '`nilai_angka`', // Expression
            '`nilai_angka`', // Basic search expression
            131, // Type
            6, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`nilai_angka`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->nilai_angka->InputTextType = "text";
        $this->nilai_angka->Raw = true;
        $this->nilai_angka->DefaultErrorMessage = $this->language->phrase("IncorrectFloat");
        $this->nilai_angka->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->Fields['nilai_angka'] = &$this->nilai_angka;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "khs";
    }
    ...
    protected function loadDbValues(?array $row)
    {
        ...
        $this->mahasiswa_id->DbValue = $row['mahasiswa_id'];
        $this->matakuliah_id->DbValue = $row['matakuliah_id'];
        $this->tahun_akademik_id->DbValue = $row['tahun_akademik_id'];
        $this->nilai_huruf->DbValue = $row['nilai_huruf'];
        $this->nilai_angka->DbValue = $row['nilai_angka'];
    }
    ...
    public function getReturnUrl(): string
    {
        ...
        return Session($name) ?? GetUrl("khslist");
    }
    ...
    public function getModalCaption(string $pageName): string
    {
        return match ($pageName) {
            "khsview" => $this->language->phrase("View"),
            "khsedit" => $this->language->phrase("Edit"),
            "khsadd" => $this->language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName(string $action): string
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "KhsView",
            Config("API_ADD_ACTION") => "KhsAdd",
            Config("API_EDIT_ACTION") => "KhsEdit",
            Config("API_DELETE_ACTION") => "KhsDelete",
            Config("API_LIST_ACTION") => "KhsList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("khsview", $parm);
        } else {
            $url = $this->keyUrl("khsview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("khslist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("khslist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl(string $parm = ""): string
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("khsdelete", $parm);
        }
    }
    ...
    public function renderListRow()
    {
        ...
        $this->mahasiswa_id->TooltipValue = "";

        // matakuliah_id
        $this->matakuliah_id->HrefValue = "";
        $this->matakuliah_id->TooltipValue = "";

        // tahun_akademik_id
        $this->tahun_akademik_id->HrefValue = "";
        $this->tahun_akademik_id->TooltipValue = "";

        // nilai_huruf
        $this->nilai_huruf->HrefValue = "";
        $this->nilai_huruf->TooltipValue = "";

        // nilai_angka
        $this->nilai_angka->HrefValue = "";
        $this->nilai_angka->TooltipValue = "";
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->mahasiswa_id);
                    $doc->exportCaption($this->matakuliah_id);
                    $doc->exportCaption($this->tahun_akademik_id);
                    $doc->exportCaption($this->nilai_huruf);
                    $doc->exportCaption($this->nilai_angka);
                } else {
                    $doc->exportCaption($this->id);
                    $doc->exportCaption($this->mahasiswa_id);
                    $doc->exportCaption($this->matakuliah_id);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->mahasiswa_id);
                        $doc->exportField($this->matakuliah_id);
                        $doc->exportField($this->tahun_akademik_id);
                        $doc->exportField($this->nilai_huruf);
                        $doc->exportField($this->nilai_angka);
                    } else {
                        $doc->exportField($this->id);
                        $doc->exportField($this->mahasiswa_id);
                        $doc->exportField($this->matakuliah_id);
