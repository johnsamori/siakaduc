...
class KhsDelete extends Khs
{
    ...
    // Page object name
    public string $PageObjName = "KhsDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "khsdelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("khslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("khslist"); // Return to list
                return;
            }
        }
