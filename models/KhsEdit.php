...
class KhsEdit extends Khs
{
    ...
    // Page object name
    public string $PageObjName = "KhsEdit";
    ...
    // CSS class/style
    public string $CurrentPageName = "khsedit";
...
// Get upload files
    ...
    protected function getEditRow(array $oldRow): array
    {
        ...
        // nilai_huruf
        $this->nilai_huruf->setDbValueDef($newRow, $this->nilai_huruf->CurrentValue, $this->nilai_huruf->ReadOnly);

        // nilai_angka
        $this->nilai_angka->setDbValueDef($newRow, $this->nilai_angka->CurrentValue, $this->nilai_angka->ReadOnly);
        return $newRow;
    }
    ...
    protected function restoreEditFormFromRow(array $row): void
    {
        ...
        if (isset($row['nilai_huruf'])) { // nilai_huruf
            $this->nilai_huruf->CurrentValue = $row['nilai_huruf'];
        }
        if (isset($row['nilai_angka'])) { // nilai_angka
            $this->nilai_angka->CurrentValue = $row['nilai_angka'];
        }
    }
