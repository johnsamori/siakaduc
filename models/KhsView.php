...
class KhsView extends Khs
{
    ...
    // Page object name
    public string $PageObjName = "KhsView";
    ...
    // CSS class/style
    public string $CurrentPageName = "khsview";
...
// Is modal
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "khslist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("khslist"); // Return to list page
                        return;
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "khslist"; // No matching record, return to list
                    } else {
