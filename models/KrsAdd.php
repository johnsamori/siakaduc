...
class KrsAdd extends Krs
{
    ...
    // Page object name
    public string $PageObjName = "KrsAdd";
    ...
    // CSS class/style
    public string $CurrentPageName = "krsadd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                if ($this->addRow($oldRow)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "krsview") {
...
// Get upload files
    ...
    protected function getAddRow(): array
    {
        ...
        // tanggal_pengisian
        $this->tanggal_pengisian->setDbValueDef($newRow, UnFormatDateTime($this->tanggal_pengisian->CurrentValue, $this->tanggal_pengisian->formatPattern()), false);
        return $newRow;
    }
