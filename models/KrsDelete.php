...
class KrsDelete extends Krs
{
    ...
    // Page object name
    public string $PageObjName = "KrsDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "krsdelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("krslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("krslist"); // Return to list
                return;
            }
        }
