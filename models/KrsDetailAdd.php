 ...
 * Page class
 */
class KrsDetailAdd extends KrsDetail
{
    use MessagesTrait;
    use FormTrait;
    ...
    // Page object name
    public string $PageObjName = "KrsDetailAdd";
    ...
    // CSS class/style
    public string $CurrentPageName = "krsdetailadd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                if ($this->addRow($oldRow)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "krsdetailview") {
...
// Get upload files
    ...
    protected function getAddRow(): array
    {
        ...
        // krs_id
        $this->krs_id->setDbValueDef($newRow, $this->krs_id->CurrentValue, false);
