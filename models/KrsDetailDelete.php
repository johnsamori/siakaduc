 ...
 * Page class
 */
class KrsDetailDelete extends KrsDetail
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "KrsDetailDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "krsdetaildelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("krsdetaillist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("krsdetaillist"); // Return to list
                return;
            }
        }
