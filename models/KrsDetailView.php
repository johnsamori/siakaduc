 ...
 * Page class
 */
class KrsDetailView extends KrsDetail
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "KrsDetailView";
    ...
    // CSS class/style
    public string $CurrentPageName = "krsdetailview";
...
// Is modal
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "krsdetaillist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("krsdetaillist"); // Return to list page
                        return;
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "krsdetaillist"; // No matching record, return to list
                    } else {
