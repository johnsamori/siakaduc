...
class KrsView extends Krs
{
    ...
    // Page object name
    public string $PageObjName = "KrsView";
    ...
    // CSS class/style
    public string $CurrentPageName = "krsview";
...
// Is modal
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "krslist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("krslist"); // Return to list page
                        return;
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "krslist"; // No matching record, return to list
                    } else {
