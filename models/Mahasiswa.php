...
class Mahasiswa extends DbTable implements LookupTableInterface
{
    ...
    public function __construct(Language $language, AdvancedSecurity $security)
    {
        ...
        $this->angkatan->Raw = true;
        $this->angkatan->DefaultErrorMessage = $this->language->phrase("IncorrectInteger");
        $this->angkatan->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
