...
// Get upload files
    ...
    protected function loadFormValues(): void
    {
        ...
        if (!$this->angkatan->IsDetailKey) {
            if (IsApi() && $val === null) {
                ...
                $this->angkatan->setFormValue($val, true, $validate);
            }
        }
    ...
    public function renderRow(): void
    {
        ...
        if ($this->RowType == RowType::VIEW) {
            ...
            if (strval($this->angkatan->EditValue) != "" && is_numeric($this->angkatan->EditValue)) {
                $this->angkatan->EditValue = $this->angkatan->EditValue;
            }
    ...
    protected function validateForm(): bool
    {
        ...
        $validateForm = true;
            ...
            if (!CheckInteger($this->angkatan->FormValue)) {
                $this->angkatan->addErrorMessage($this->angkatan->getErrorMessage(false));
            }
    ...
    protected function getEditRow(array $oldRow): array
    {
        ...
        // prodi_id
        $this->prodi_id->setDbValueDef($newRow, $this->prodi_id->CurrentValue, $this->prodi_id->ReadOnly);
    ...
    protected function restoreEditFormFromRow(array $row): void
    {
        ...
        if (isset($row['prodi_id'])) { // prodi_id
            $this->prodi_id->CurrentValue = $row['prodi_id'];
        }
