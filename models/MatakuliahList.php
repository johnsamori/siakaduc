...
class MatakuliahList extends Matakuliah
{
    ...
    public string $FormName = "fmatakuliahlist";
    ...
    public function setVisibility(): void
    {
        ...
        $this->nama_mk->setVisibility();
        $this->sks->setVisibility();
        $this->prodi_id->setVisibility();
        $this->dosen_id->setVisibility();
    }
    ...
    public function __construct(Language $language, AdvancedSecurity $security)
    {
        ...
        // Table object (matakuliah)
        if (!isset($GLOBALS["matakuliah"]) || $GLOBALS["matakuliah"]::class == PROJECT_NAMESPACE . "matakuliah") {
            $GLOBALS["matakuliah"] = &$this;
        }
        ...
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'matakuliah');
        }
...
// Is modal
		...
		if (ReadCookie('matakuliah_searchpanel') == 'notactive' || ReadCookie('matakuliah_searchpanel') == "") {
			RemoveClass($this->SearchPanelClass, "show");
			AppendClass($this->SearchPanelClass, "collapse");
		} elseif (ReadCookie('matakuliah_searchpanel') == 'active') {
    ...
    public function getFilterList(): string
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server") {
            $savedFilterList = Profile()->getSearchFilters("fmatakuliahsrch");
        }
        $filterList = Concat($filterList, $this->id->AdvancedSearch->toJson(), ","); // Field id
        $filterList = Concat($filterList, $this->kode_mk->AdvancedSearch->toJson(), ","); // Field kode_mk
        $filterList = Concat($filterList, $this->nama_mk->AdvancedSearch->toJson(), ","); // Field nama_mk
        $filterList = Concat($filterList, $this->sks->AdvancedSearch->toJson(), ","); // Field sks
        $filterList = Concat($filterList, $this->prodi_id->AdvancedSearch->toJson(), ","); // Field prodi_id
        $filterList = Concat($filterList, $this->dosen_id->AdvancedSearch->toJson(), ","); // Field dosen_id
        if ($this->BasicSearch->Keyword != "") {
    ...
    protected function processFilterList(): bool
    {
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            Profile()->setSearchFilters("fmatakuliahsrch", $filters);
    ...
    protected function restoreFilterList(): void
    {
        ...
        // Field nama_mk
        $this->nama_mk->AdvancedSearch->SearchValue = $filter["x_nama_mk"] ?? "";
        $this->nama_mk->AdvancedSearch->SearchOperator = $filter["z_nama_mk"] ?? "";
        $this->nama_mk->AdvancedSearch->SearchCondition = $filter["v_nama_mk"] ?? "";
        $this->nama_mk->AdvancedSearch->SearchValue2 = $filter["y_nama_mk"] ?? "";
        $this->nama_mk->AdvancedSearch->SearchOperator2 = $filter["w_nama_mk"] ?? "";
        $this->nama_mk->AdvancedSearch->save();
        ...
        // Field prodi_id
        $this->prodi_id->AdvancedSearch->SearchValue = $filter["x_prodi_id"] ?? "";
        $this->prodi_id->AdvancedSearch->SearchOperator = $filter["z_prodi_id"] ?? "";
        $this->prodi_id->AdvancedSearch->SearchCondition = $filter["v_prodi_id"] ?? "";
        $this->prodi_id->AdvancedSearch->SearchValue2 = $filter["y_prodi_id"] ?? "";
        $this->prodi_id->AdvancedSearch->SearchOperator2 = $filter["w_prodi_id"] ?? "";
        $this->prodi_id->AdvancedSearch->save();

        // Field dosen_id
        $this->dosen_id->AdvancedSearch->SearchValue = $filter["x_dosen_id"] ?? "";
        $this->dosen_id->AdvancedSearch->SearchOperator = $filter["z_dosen_id"] ?? "";
        $this->dosen_id->AdvancedSearch->SearchCondition = $filter["v_dosen_id"] ?? "";
        $this->dosen_id->AdvancedSearch->SearchValue2 = $filter["y_dosen_id"] ?? "";
        $this->dosen_id->AdvancedSearch->SearchOperator2 = $filter["w_dosen_id"] ?? "";
        $this->dosen_id->AdvancedSearch->save();
    ...
    protected function setupSortOrder(): void
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->nama_mk); // nama_mk
            $this->updateSort($this->sks); // sks
            $this->updateSort($this->prodi_id); // prodi_id
            $this->updateSort($this->dosen_id); // dosen_id
    ...
    protected function resetCmd(): void
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->nama_mk->setSort("");
                $this->sks->setSort("");
                $this->prodi_id->setSort("");
                $this->dosen_id->setSort("");
            }
        ...
        if ($this->CurrentMode == "view") {
            ...
            if ($this->security->canView()) {
                if ($this->ModalView && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-view\" title=\"" . $viewcaption . "\" data-table=\"matakuliah\" data-caption=\"" . $viewcaption . "\" data-ew-action=\"modal\" data-action=\"view\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->ViewUrl)) . "\" data-btn=\"null\">" . $this->language->phrase("ViewLink") . "</a>";
                } else {
            ...
            if ($this->security->canEdit()) {
                if ($this->ModalEdit && !IsMobile()) {
					$opt->Body = "<a class=\"ew-row-link ew-edit\" title=\"" . $editcaption . "\" data-table=\"matakuliah\" data-caption=\"" . $editcaption . "\" data-ew-action=\"modal\" data-action=\"edit\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->EditUrl)) . "\" data-ask=\"1\" data-btn=\"SaveBtn\">" . $this->language->phrase("EditLink") . "</a>";
                } else {
            ...
            if ($this->security->canAdd()) {
                if ($this->ModalAdd && !IsMobile()) {
					$opt->Body = "<a class=\"ew-row-link ew-copy\" title=\"" . $copycaption . "\" data-table=\"matakuliah\" data-caption=\"" . $copycaption . "\" data-ew-action=\"modal\" data-action=\"add\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->CopyUrl)) . "\" data-ask=\"1\" data-btn=\"AddBtn\">" . $this->language->phrase("CopyLink") . "</a>";
                } else {
            ...
            foreach ($this->ListActions as $listAction) { // ActionType::SINGLE
                ...
                if ($listAction->Select == ActionType::SINGLE && $listAction->getVisible()) {
                    ...
                    $link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action" . ($listAction->getEnabled() ? "" : " disabled") .
                        "\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fmatakuliahlist\" data-key=\"" . $this->keyToJson(true) .
                    ...
                    if ($body == "") { // Setup first button
                        $body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action" . ($listAction->getEnabled() ? "" : " disabled") .
                            "\" title=\"" . $title . "\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fmatakuliahlist\" data-key=\"" . $this->keyToJson(true) .
    ...
    protected function setupOtherOptions(): void
    {
        ...
        if ($this->ModalAdd && !IsMobile()) {
			$item->Body = "<a class=\"ew-add-edit ew-add\" title=\"" . $addcaption . "\" data-table=\"matakuliah\" data-caption=\"" . $addcaption . "\" data-ew-action=\"modal\" data-action=\"add\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->AddUrl)) . "\" data-ask=\"1\" data-btn=\"AddBtn\">" . $this->language->phrase("AddLink") . "</a>";
        } else {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $this->createColumnOption($option, "nama_mk");
            $this->createColumnOption($option, "sks");
            $this->createColumnOption($option, "prodi_id");
            $this->createColumnOption($option, "dosen_id");
        }
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fmatakuliahsrch\" data-ew-action=\"none\">" . $this->language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fmatakuliahsrch\" data-ew-action=\"none\">" . $this->language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions(): void
    {
        ...
        foreach ($this->ListActions as $listAction) { // ActionType::MULTIPLE
            if ($listAction->Select == ActionType::MULTIPLE && $listAction->getVisible()) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="fmatakuliahlist"' . $listAction->toDataAttributes() . '>' . $icon . '</button>';
                $item->Visible = true;
            }
        }
    ...
    public function setupRow(): void
    {
        if ($this->isGridAdd() || $this->isGridEdit()) {
            if ($this->RowIndex === '$rowindex$') { // Render template row first
                ...
                // Set row properties
                $this->resetAttributes();
                $this->RowAttrs->merge(["data-rowindex" => $this->RowIndex, "id" => "r0_matakuliah", "data-rowtype" => RowType::ADD]);
        ...
        $this->RowAttrs->merge([
            ...
            "id" => "r" . $this->RowCount . "_matakuliah",
...
// Load basic search values
    ...
    public function loadRowValues(array|bool|null $row = null): void
    {
        ...
        $this->nama_mk->setDbValue($row['nama_mk']);
        $this->sks->setDbValue($row['sks']);
        $this->prodi_id->setDbValue($row['prodi_id']);
        $this->dosen_id->setDbValue($row['dosen_id']);
    }
    ...
    protected function newRow(): array
    {
        ...
        $row['nama_mk'] = $this->nama_mk->DefaultValue;
        $row['sks'] = $this->sks->DefaultValue;
        $row['prodi_id'] = $this->prodi_id->DefaultValue;
        $row['dosen_id'] = $this->dosen_id->DefaultValue;
        return $row;
    }
    ...
    public function renderRow(): void
    {
        ...
        if ($this->RowType == RowType::VIEW) {
            ...
            // nama_mk
            $this->nama_mk->ViewValue = $this->nama_mk->CurrentValue;

            // sks
            $this->sks->ViewValue = $this->sks->CurrentValue;
            $this->sks->ViewValue = FormatNumber($this->sks->ViewValue, $this->sks->formatPattern());

            // prodi_id
            $this->prodi_id->ViewValue = $this->prodi_id->CurrentValue;
            $this->prodi_id->ViewValue = FormatNumber($this->prodi_id->ViewValue, $this->prodi_id->formatPattern());

            // dosen_id
            $this->dosen_id->ViewValue = $this->dosen_id->CurrentValue;
            $this->dosen_id->ViewValue = FormatNumber($this->dosen_id->ViewValue, $this->dosen_id->formatPattern());
            ...
            // nama_mk
            $this->nama_mk->HrefValue = "";
            $this->nama_mk->TooltipValue = "";
            ...
            // prodi_id
            $this->prodi_id->HrefValue = "";
            $this->prodi_id->TooltipValue = "";

            // dosen_id
            $this->dosen_id->HrefValue = "";
            $this->dosen_id->TooltipValue = "";
        }
	...
	// Begin of add Search Panel Status by Masino Sinaga, October 13, 2024
		...
		if (ReadCookie('matakuliah_searchpanel') == 'notactive' || ReadCookie('matakuliah_searchpanel') == "") {
			$item->Body = "<a class=\"btn btn-default ew-search-toggle\" role=\"button\" title=\"" . $this->language->phrase("SearchPanel") . "\" data-caption=\"" . $this->language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fmatakuliahsrch\" aria-pressed=\"false\">" . $this->language->phrase("SearchLink") . "</a>";
		} elseif (ReadCookie('matakuliah_searchpanel') == 'active') {
			$item->Body = "<a class=\"btn btn-default ew-search-toggle active\" role=\"button\" title=\"" . $this->language->phrase("SearchPanel") . "\" data-caption=\"" . $this->language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fmatakuliahsrch\" aria-pressed=\"true\">" . $this->language->phrase("SearchLink") . "</a>";
		} else {
			$item->Body = "<a class=\"btn btn-default ew-search-toggle\" role=\"button\" title=\"" . $this->language->phrase("SearchPanel") . "\" data-caption=\"" . $this->language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fmatakuliahsrch\" aria-pressed=\"false\">" . $this->language->phrase("SearchLink") . "</a>";
		}
        $item->Visible = true;
