 ...
 * Page class
 */
class ProdiDelete extends Prodi
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "ProdiDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "prodidelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("prodilist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("prodilist"); // Return to list
                return;
            }
        }
