...
class ProdiView extends Prodi
{
    ...
    // Page object name
    public string $PageObjName = "ProdiView";
    ...
    // CSS class/style
    public string $CurrentPageName = "prodiview";
...
// Is modal
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "prodilist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("prodilist"); // Return to list page
                        return;
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "prodilist"; // No matching record, return to list
                    } else {
