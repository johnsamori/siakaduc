...
class TahunAkademik extends DbTable implements LookupTableInterface
{
    ...
    public function __construct(Language $language, AdvancedSecurity $security)
    {
        ...
        $this->tahun->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        ...
        $this->semester->Raw = true;
        global $CurrentLanguage;
        switch ($CurrentLanguage) {
            case "en-US":
                $this->semester->Lookup = new Lookup($this->semester, 'tahun_akademik', false, '', ["","","",""], '', "", [], [], [], [], [], [], false, '', '', "");
                break;
            default:
                $this->semester->Lookup = new Lookup($this->semester, 'tahun_akademik', false, '', ["","","",""], '', "", [], [], [], [], [], [], false, '', '', "");
                break;
        ...
        $this->semester->SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"];
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->status->Lookup = new Lookup($this->status, 'tahun_akademik', false, '', ["","","",""], '', "", [], [], [], [], [], [], false, '', '', "");
                break;
            default:
                $this->status->Lookup = new Lookup($this->status, 'tahun_akademik', false, '', ["","","",""], '', "", [], [], [], [], [], [], false, '', '', "");
                break;
