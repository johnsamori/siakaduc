...
// Get upload files
    ...
    public function renderRow(): void
    {
        ...
        if ($this->RowType == RowType::VIEW) {
            ...
            $this->tahun->EditValue = !$this->tahun->Raw ? HtmlDecode($this->tahun->CurrentValue) : $this->tahun->CurrentValue;
    ...
    protected function getAddRow(): array
    {
        ...
        // tahun
        $this->tahun->setDbValueDef($newRow, $this->tahun->CurrentValue, false);
