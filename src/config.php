...
$CONFIG = [
    ...
    "PROJECT_STYLESHEET_FILENAME" => "css/new2025.css", // Project stylesheet file name
    ...
    "SIDEBAR_CLASS" => "main-sidebar sidebar-dark-blue elevation-4", // CSS class(es) for sidebar
    ...
    // Export Log
    "EXPORT_PATH" => "export-1cc1ed58-b5f5-4803-92ae-63548e8546d7", // Export folder
