...
return [
    ...
    "fakultas" => \DI\autowire(Fakultas::class),
    "khs" => \DI\autowire(Khs::class),
    "krs" => \DI\autowire(Krs::class),
    "krs_detail" => \DI\autowire(KrsDetail::class),
    "mahasiswa" => \DI\autowire(Mahasiswa::class),
    "matakuliah" => \DI\autowire(Matakuliah::class),
    "prodi" => \DI\autowire(Prodi::class),
