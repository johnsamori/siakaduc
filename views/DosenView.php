...
<?php if ($Page->id->Visible) { // id ?>
    <tr id="r_id"<?= $Page->id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_dosen_id"><?= $Page->id->caption() ?></span></td>
...
<?php if ($Page->nama->Visible) { // nama ?>
    <tr id="r_nama"<?= $Page->nama->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_dosen_nama"><?= $Page->nama->caption() ?></span></td>
...
<?php if ($Page->email->Visible) { // email ?>
    <tr id="r_email"<?= $Page->email->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_dosen_email"><?= $Page->email->caption() ?></span></td>
...
<?php if ($Page->prodi_id->Visible) { // prodi_id ?>
    <tr id="r_prodi_id"<?= $Page->prodi_id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_dosen_prodi_id"><?= $Page->prodi_id->caption() ?></span></td>
