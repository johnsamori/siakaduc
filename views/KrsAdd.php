...
<form name="fkrsadd" id="fkrsadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
...
<script<?= Nonce() ?>>
loadjs.ready(['fkrsadd', 'jqueryinputmask'], function() {
	options = {
		'alias': 'numeric',
		'autoUnmask': true,
		'jitMasking': false,
	...
	ew.createjQueryInputMask("fkrsadd", "x_mahasiswa_id", jQuery.extend(true, "", options));
});
</script>
</span>
</div></div>
...
loadjs.ready(['fkrsadd', 'jqueryinputmask'], function() {
	...
	ew.createjQueryInputMask("fkrsadd", "x_tahun_akademik_id", jQuery.extend(true, "", options));
});
</script>
</span>
</div></div>
...
<script<?= Nonce() ?>>
loadjs.ready(["fkrsadd", "datetimepicker"], function () {
...
loadjs.ready(['fkrsadd', 'jqueryinputmask'], function() {
	...
	ew.createjQueryInputMask("fkrsadd", "x_tanggal_pengisian", jQuery.extend(true, "", options));
});
</script>
</span>
</div></div>
...
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit" form="fkrsadd"><?= $Language->phrase("AddBtn") ?></button>
<?php if (IsJsonResponse()) { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-bs-dismiss="modal"><?= $Language->phrase("CancelBtn") ?></button>
<?php } else { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" form="fkrsadd" data-href="<?= HtmlEncode(GetUrl($Page->getReturnUrl())) ?>"><?= $Language->phrase("CancelBtn") ?></button>
<?php } ?>
    </div><!-- /buttons offset -->
