...
$Page->showMessage();
?>
<form name="fkrsdelete" id="fkrsdelete" class="ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
...
<?php if ($Page->id->Visible) { // id ?>
        <th class="<?= $Page->id->headerCellClass() ?>"><span id="elh_krs_id" class="krs_id"><?= $Page->id->caption() ?></span></th>
<?php } ?>
<?php if ($Page->mahasiswa_id->Visible) { // mahasiswa_id ?>
        <th class="<?= $Page->mahasiswa_id->headerCellClass() ?>"><span id="elh_krs_mahasiswa_id" class="krs_mahasiswa_id"><?= $Page->mahasiswa_id->caption() ?></span></th>
<?php } ?>
<?php if ($Page->tahun_akademik_id->Visible) { // tahun_akademik_id ?>
        <th class="<?= $Page->tahun_akademik_id->headerCellClass() ?>"><span id="elh_krs_tahun_akademik_id" class="krs_tahun_akademik_id"><?= $Page->tahun_akademik_id->caption() ?></span></th>
<?php } ?>
<?php if ($Page->tanggal_pengisian->Visible) { // tanggal_pengisian ?>
        <th class="<?= $Page->tanggal_pengisian->headerCellClass() ?>"><span id="elh_krs_tanggal_pengisian" class="krs_tanggal_pengisian"><?= $Page->tanggal_pengisian->caption() ?></span></th>
<?php } ?>
    </tr>
    </thead>
    <tbody>
...
<?php } ?>
<?php if ($Page->tanggal_pengisian->Visible) { // tanggal_pengisian ?>
        <td<?= $Page->tanggal_pengisian->cellAttributes() ?>>
<span id="">
