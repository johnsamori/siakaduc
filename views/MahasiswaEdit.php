...
<?php if ($Page->id->Visible) { // id ?>
    <div id="r_id"<?= $Page->id->rowAttributes() ?>>
        <label id="elh_mahasiswa_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->id->caption() ?><?= $Page->id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->id->cellAttributes() ?>>
<span id="el_mahasiswa_id">
...
<input type="hidden" data-table="mahasiswa" data-field="x_id" data-hidden="1" name="x_id" id="x_id" value="<?= HtmlEncode($Page->id->CurrentValue) ?>">
</span>
</div></div>
    </div>
<?php } ?>
...
<input type="<?= $Page->nim->getInputTextType() ?>" name="x_nim" id="x_nim" data-table="mahasiswa" data-field="x_nim" value="<?= $Page->nim->getEditValue() ?>" size="30" maxlength="20" placeholder="<?= HtmlEncode($Page->nim->getPlaceHolder()) ?>" data-format-pattern="<?= HtmlEncode($Page->nim->formatPattern()) ?>"<?= $Page->nim->editAttributes() ?> aria-describedby="x_nim_help">
...
loadjs.ready(['fmahasiswaedit', 'jqueryinputmask'], function() {
	...
	ew.createjQueryInputMask("fmahasiswaedit", "x_prodi_id", jQuery.extend(true, "", options));
});
</script>
</span>
</div></div>
...
loadjs.ready(['fmahasiswaedit', 'jqueryinputmask'], function() {
	...
	ew.createjQueryInputMask("fmahasiswaedit", "x_user_id", jQuery.extend(true, "", options));
});
</script>
</span>
</div></div>
