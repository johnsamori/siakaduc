...
<?php if ($Page->id->Visible) { // id ?>
        <th data-name="id" class="<?= $Page->id->headerCellClass() ?>"><div id="elh_mahasiswa_id" class="mahasiswa_id"><?= $Page->renderFieldHeader($Page->id) ?></div></th>
<?php } ?>
...
<?php if ($Page->prodi_id->Visible) { // prodi_id ?>
        <th data-name="prodi_id" class="<?= $Page->prodi_id->headerCellClass() ?>"><div id="elh_mahasiswa_prodi_id" class="mahasiswa_prodi_id"><?= $Page->renderFieldHeader($Page->prodi_id) ?></div></th>
<?php } ?>
<?php if ($Page->user_id->Visible) { // user_id ?>
        <th data-name="user_id" class="<?= $Page->user_id->headerCellClass() ?>"><div id="elh_mahasiswa_user_id" class="mahasiswa_user_id"><?= $Page->renderFieldHeader($Page->user_id) ?></div></th>
<?php } ?>
<?php
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_mahasiswa_id" class="el_mahasiswa_id">
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_mahasiswa_prodi_id" class="el_mahasiswa_prodi_id">
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_mahasiswa_user_id" class="el_mahasiswa_user_id">
