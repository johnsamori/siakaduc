...
<?php if ($Page->id->Visible) { // id ?>
    <tr id="r_id"<?= $Page->id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_mahasiswa_id"><?= $Page->id->caption() ?></span></td>
...
<?php if ($Page->prodi_id->Visible) { // prodi_id ?>
    <tr id="r_prodi_id"<?= $Page->prodi_id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_mahasiswa_prodi_id"><?= $Page->prodi_id->caption() ?></span></td>
...
<?php if ($Page->user_id->Visible) { // user_id ?>
    <tr id="r_user_id"<?= $Page->user_id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_mahasiswa_user_id"><?= $Page->user_id->caption() ?></span></td>
